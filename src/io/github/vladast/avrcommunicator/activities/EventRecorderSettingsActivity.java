 ...
 */
public class EventRecorderSettingsActivity extends PreferenceActivity {
	/**
	...
	/**
	 * Preferences key for number of events
	 */
	public static final String KEY_PREF_EVENT_NUMBER = "event_number";
	/**
	 * Preferences key for device monitoring
	 */
	public static final String KEY_PREF_MONITOR_DEVICES = "monitor_devices";
	/**
	 * Preferences key for monitoring interval
	 */
	public static final String KEY_PREF_MONITOR_INTERVAL = "monitor_interval";
	/**
	 * Preferences key for sleep prevention
	 */
	public static final String KEY_PREF_PREVENT_SLEEP = "prevent_sleep";
	/**
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
	public static class TouchablesPreferenceFragment extends PreferenceFragment {
		@Override
		public void onCreate(Bundle savedInstanceState) {
			super.onCreate(savedInstanceState);
			addPreferencesFromResource(R.xml.preferences);
			...
			//bindPreferenceSummaryToValue(findPreference("prevent_sleep"));
		}
	}
	...
	public static class NotificationPreferenceFragment extends
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			// updated to reflect the new value, per the Android Design
			// guidelines.
			// TODO: Implement when notification feature gets implemented
			//bindPreferenceSummaryToValue(findPreference("to_be_defined"));
		}
	}
}
